...
clarinet_results_directory = (
    "/Users/lucasmarch/Projects/MUMT620_Project/yolov5/runs/detect/exp2/labels"
)
...
person_results_directory = (
    "/Users/lucasmarch/Projects/MUMT620_Project/yolov5/runs/detect/exp5/labels"
)
person_positions = read_person_positions(person_results_directory)
...
forward_backward_frames, forward_backward_movements = zip(*forward_backward_movement)
